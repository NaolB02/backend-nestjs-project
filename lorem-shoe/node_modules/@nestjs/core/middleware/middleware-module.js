...
class MiddlewareModule {
    ...
    async registerHandler(applicationRef, { path, method, version }, proxy) {
        ...
        if (version && applicationVersioningConfig.type === common_1.VersioningType.URI) {
