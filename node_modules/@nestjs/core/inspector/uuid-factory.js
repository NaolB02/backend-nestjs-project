...
const random_string_generator_util_1 = require("../../common/utils/random-string-generator.util");
...
class UuidFactory {
    ...
    static get(key = '', namespace) {
        return this._mode === UuidFactoryMode.Deterministic
            ? deterministic_uuid_registry_1.DeterministicUuidRegistry.get(key, namespace)
